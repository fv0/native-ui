...
const TAB_CLOSE_BUTTON_POSITION_CONFIG = "native-ui.tabCloseButtonPosition";
const TAB_HEIGHT_CONFIG = "native-ui.tabHeight";
const TAB_MAX_WIDTH_CONFIG = "native-ui.tabMaxWidth";
...
function writeCustomStyle(options) {
	...
	fs.writeFile(`${__dirname}/../styles/custom.less`, customStyleContent, "utf8", () => {
		if (!options || !options.noReload) {
			var themePackage = atom.packages.getLoadedPackage("native-ui");
